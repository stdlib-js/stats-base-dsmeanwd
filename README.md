...
```javascript
import dsmeanwd from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-dsmeanwd@deno/mod.js';
```
The previous example will load the latest bundled code from the deno branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/stats-base-dsmeanwd/tags). For example,

```javascript
import dsmeanwd from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-dsmeanwd@v0.2.0-deno/mod.js';
```
